...
use nidrs::{AnyResponse, Exception, HookCtx, Inject, Interceptor, InterceptorHook, IntoAnyResponse, StateCtx};
...
impl <B: FromRequest<StateCtx> + Debug, P:IntoAnyResponse> InterceptorHook<B, P> for LogInterceptor {
    type R = AnyResponse;
