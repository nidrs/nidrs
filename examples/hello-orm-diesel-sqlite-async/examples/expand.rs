...
// << Pop: Some(Service("SqlitePoolManager")) ["service", "ServiceName", "ServiceType", "module", "global"]
...
// << Pop: Some(Handler("get_hello_world")) ["RouterName", "RouterMethod", "RouterPath", "handler", "ControllerPath", "ServiceType", "ServiceName", "service", "module", "global"]
...
// route_derive is_tuple false
// << Pop: Some(Handler("get_user_all")) ["RouterMethod", "RouterPath", "RouterName", "handler", "service", "ServiceType", "ControllerPath", "ServiceName", "module", "global"]
...
// route_derive is_tuple false
// << Pop: Some(Handler("get_user_by_id")) ["RouterPath", "handler", "RouterMethod", "RouterName", "service", "ServiceType", "ControllerPath", "ServiceName", "module", "global"]
...
// route_derive is_tuple false
// << Pop: Some(Handler("create_user")) ["handler", "RouterMethod", "RouterName", "RouterPath", "service", "ServiceType", "ControllerPath", "ServiceName", "module", "global"]
...
mod app {
    ...
    impl nidrs::Module for AppModule {
        fn init(self, mut ctx: nidrs::ModuleCtx) -> nidrs::ModuleCtx {
            ...
            let mut dyn_module = DieselModule::for_root(DieselOptions { driver: SqlitePoolManager::new("file:db.sqlite3") });
...
mod shared {
    pub mod fn_test {
        ...
        pub fn fn_test() -> AppResult {
            nidrs::__throw(
                Exception::new(StatusCode::INTERNAL_SERVER_ERROR, nidrs::externs::anyhow::Error::msg("Error")),
