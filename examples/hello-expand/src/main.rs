...
// meta "AppController" ["__METADATA__:DefaultPrefix::default"]
// meta "AppController" ["__METADATA__:DefaultPrefix::Disabled"]
...
// meta "ConfModule" ["__METADATA__:Global::Enabled"]
// injectable LogService
// meta "LogModule" ["__METADATA__:Global::Enabled"]
    ...
    pub mod controller {
        ...
        impl nidrs::ImplMeta for AppController {
            fn __meta() -> nidrs::Meta {
                ...
                meta.set_data(DefaultPrefix::default());
                meta.set_data(DefaultPrefix::Disabled);
    ...
    impl nidrs::Module for AppModule {
        fn init(self, mut ctx: nidrs::ModuleCtx) -> nidrs::ModuleCtx {
            ...
            ctx.append_exports(
                "ConfModule",
                dyn_module_exports,
                nidrs::get_meta_by_type::<ConfModule>().get_data::<nidrs::metadata::Global>().unwrap_or(&nidrs::metadata::Global::Disabled).as_bool(),
            );
