...
// << Pop: Some(Handler("get_hello_world")) ["RouterMethod", "RouterPath", "DisableDefaultPrefix", "handler", "version", "arr", "RouterName", "auth", "service", "ServiceType", "role", "ServiceName", "service_uses", "ControllerPath", "module", "global"]
...
// << Pop: Some(Handler("post_hello_world")) ["RouterName", "RouterPath", "handler", "RouterMethod", "auth", "service", "ServiceType", "role", "version", "ServiceName", "service_uses", "ControllerPath", "module", "global"]

// << Pop: Some(Service("AppController")) ["auth", "service", "ServiceType", "role", "version", "ServiceName", "service_uses", "ControllerPath", "module", "global"]
...
// module2 Array(Array([Object(Object({"services": Array(Array([Ident(Ident("AppService"))])), "exports": Array(Array([Ident(Ident("AppService"))])), "interceptors": Array(Array([Ident(Ident("AppInterceptor"))])), "imports": Array(Array([Ident(Ident("UserModule"))])), "controllers": Array(Array([Ident(Ident("AppController"))]))}))]))
// module "AppModule"
...
// << Pop: Some(Handler("get_hello_world")) ["handler", "RouterMethod", "RouterName", "RouterPath", "ServiceType", "ControllerPath", "ServiceName", "service", "module", "global"]
...
// << Pop: Some(Handler("create_user")) ["RouterName", "RouterPath", "handler", "RouterMethod", "ServiceType", "ControllerPath", "ServiceName", "service", "module", "global"]
