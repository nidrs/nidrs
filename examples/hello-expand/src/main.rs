...
// << Pop: Some(Handler("get_hello_world")) ["RouterPath", "arr", "handler", "version", "RouterName", "DisableDefaultPrefix", "RouterMethod", "ServiceName", "service", "service_uses", "ControllerPath", "ServiceType", "auth", "role", "module", "global"]
...
// << Pop: Some(Handler("post_hello_world")) ["handler", "RouterPath", "RouterMethod", "RouterName", "ServiceName", "service", "service_uses", "version", "ControllerPath", "ServiceType", "auth", "role", "module", "global"]

// << Pop: Some(Service("AppController")) ["ServiceName", "service", "service_uses", "version", "ControllerPath", "ServiceType", "auth", "role", "module", "global"]
...
// << Pop: Some(Handler("get_hello_world")) ["RouterPath", "RouterName", "handler", "RouterMethod", "ServiceType", "ServiceName", "ControllerPath", "service", "module", "global"]
...
// << Pop: Some(Handler("create_user")) ["handler", "RouterName", "RouterMethod", "RouterPath", "ServiceType", "ServiceName", "ControllerPath", "service", "module", "global"]
