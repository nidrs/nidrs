...
// << Pop: Some(Handler("get_hello_world")) ["RouterMethod", "RouterPath", "arr", "version", "handler", "DisableDefaultPrefix", "RouterName", "ServiceType", "service_uses", "service", "ControllerPath", "auth", "role", "ServiceName", "module", "global"]
...
// << Pop: Some(Handler("post_hello_world")) ["RouterPath", "RouterName", "handler", "RouterMethod", "ServiceType", "service_uses", "service", "version", "ControllerPath", "auth", "role", "ServiceName", "module", "global"]

// << Pop: Some(Service("AppController")) ["ServiceType", "service_uses", "service", "version", "ControllerPath", "auth", "role", "ServiceName", "module", "global"]
...
// << Pop: Some(Handler("get_hello_world")) ["RouterName", "handler", "RouterMethod", "RouterPath", "ControllerPath", "ServiceName", "ServiceType", "service", "module", "global"]
...
// << Pop: Some(Handler("create_user")) ["RouterName", "RouterMethod", "handler", "RouterPath", "ControllerPath", "ServiceName", "ServiceType", "service", "module", "global"]
