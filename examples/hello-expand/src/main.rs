...
// << Pop: Some(Handler("get_hello_world")) ["RouterPath", "RouterMethod", "arr", "handler", "RouterName", "DisableDefaultPrefix", "version", "service_uses", "auth", "ServiceType", "role", "ServiceName", "service", "ControllerPath", "module", "global"]
...
// << Pop: Some(Handler("post_hello_world")) ["RouterPath", "RouterMethod", "RouterName", "handler", "service_uses", "auth", "ServiceType", "role", "ServiceName", "service", "ControllerPath", "version", "module", "global"]

// << Pop: Some(Service("AppController")) ["service_uses", "auth", "ServiceType", "role", "ServiceName", "service", "ControllerPath", "version", "module", "global"]

// >>Push: Service("AppInterceptor") -- [Some(String("AppModule"))]
//  CMETA: ["ServiceType"]
//  CMETA: ["ServiceName"]
// service_derive "AppInterceptor"
// << Pop: Some(Service("AppInterceptor")) ["ServiceName", "ServiceType", "service", "module", "global"]

// >>Push: Service("AppService") -- [Some(String("AppModule"))]
//  CMETA: ["ServiceType"]
//  CMETA: ["ServiceName"]
// service_derive "AppService"
// module2 F1(ModuleOptions { imports: Array([PathIdent("UserModule")]), controllers: Array([PathIdent("AppController")]), services: Array([PathIdent("AppService")]), exports: Array([PathIdent("AppService")]), interceptors: Array([PathIdent("AppInterceptor")]) })
// module "AppModule"
...
// << Pop: Some(Handler("get_hello_world")) ["RouterMethod", "RouterPath", "handler", "RouterName", "ControllerPath", "ServiceName", "ServiceType", "service", "module", "global"]
...
// << Pop: Some(Handler("create_user")) ["handler", "RouterMethod", "RouterName", "RouterPath", "ControllerPath", "ServiceName", "ServiceType", "service", "module", "global"]

// << Pop: Some(Service("UserController")) ["ControllerPath", "ServiceName", "ServiceType", "service", "module", "global"]

// >>Push: Service("UserService") -- [Some(String("UserModule"))]
//  CMETA: ["ServiceType"]
//  CMETA: ["ServiceName"]
// service_derive "UserService"
// module2 F1(ModuleOptions { imports: Array([PathIdent("AppModule")]), controllers: Array([PathIdent("UserController")]), services: Array([PathIdent("UserService")]), exports: Array([PathIdent("UserService")]), interceptors: Array([]) })
// module "UserModule"
        ...
        impl AppController {
            ...
            pub fn __route_get_hello_world(&self, mut ctx: nidrs::ModuleCtx) -> nidrs::ModuleCtx {
                ...
                let router = nidrs::externs::axum::Router::new()
                    .route(&full_path, nidrs::externs::axum::routing::get(|p0, p1| async move { t_controller.get_hello_world(p0, p1).await }))
            ...
            pub fn __route_post_hello_world(&self, mut ctx: nidrs::ModuleCtx) -> nidrs::ModuleCtx {
                ...
                let t_controller = ctx.get_controller::<Self>(module_name, controller_name);
                let router = nidrs::externs::axum::Router::new()
                    .route(&full_path, nidrs::externs::axum::routing::get(|p0, p1| async move { t_controller.post_hello_world(p0, p1).await }))
                    .layer(nidrs::externs::axum::Extension(meta.clone()))
                    .layer(axum::middleware::from_fn({
                        let inter = ctx.get_interceptor::<AppInterceptor>(module_name, "AppInterceptor");
                        move |req: axum::extract::Request, next: axum::middleware::Next| {
