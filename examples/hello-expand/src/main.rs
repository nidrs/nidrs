...
// << Pop: Some(Handler("get_hello_world")) ["RouterName", "arr", "method_uses", "DisableDefaultPrefix", "RouterPath", "handler", "RouterMethod", "version", "ServiceName", "auth", "ServiceType", "ControllerPath", "service", "role", "module", "global"]
...
// << Pop: Some(Handler("post_hello_world")) ["RouterName", "RouterPath", "handler", "RouterMethod", "ServiceName", "version", "auth", "ServiceType", "ControllerPath", "service", "role", "module", "global"]

// << Pop: Some(Service("AppController")) ["ServiceName", "version", "auth", "ServiceType", "ControllerPath", "service", "role", "module", "global"]
...
//  CMETA: ["RouterPath"]
// route_derive "get_hello_world"
// << Pop: Some(Handler("get_hello_world")) ["RouterPath", "RouterName", "handler", "RouterMethod", "service", "ServiceType", "ServiceName", "ControllerPath", "module", "global"]
...
// << Pop: Some(Handler("create_user")) ["RouterName", "RouterMethod", "handler", "RouterPath", "service", "ServiceType", "ServiceName", "ControllerPath", "module", "global"]
...
mod app {
    ...
    pub mod controller {
        ...
        use nidrs_extern::axum::http::HeaderMap;
        use crate::AppResult;
        use super::{
            dto::{ArgDto, Status},
        ...
        impl AppController {
            ...
            pub fn __route_get_hello_world(
                ...
                let router = nidrs::externs::axum::Router::new()
                    .route(
                        &full_path,
                        nidrs::externs::axum::routing::get(|p0, p1, p2| async move {
                            t_controller.get_hello_world(p0, p1, p2).await
                        }),
                    )
