...
// meta "AppController" ["METADATA:nidrs::metadata::DisableDefaultPrefix"]
// controller AppController []
// meta "AppController" ["METADATA:nidrs::metadata::ServiceType::Controller"]
// meta "AppController" ["METADATA:nidrs::metadata::ServiceName"]
// meta "AppController" ["METADATA:nidrs::metadata::ControllerPath"]
// service_derive "AppController"
// meta "get_hello_world" ["arr"]
// meta "get_hello_world" ["METADATA:nidrs::metadata::DisableDefaultPrefix"]
// meta "get_hello_world" ["version"]
// route get /hello None Some(String("v2"))
// meta "get_hello_world" ["METADATA:nidrs::metadata::RouterName"]
// meta "get_hello_world" ["METADATA:nidrs::metadata::RouterMethod"]
// meta "get_hello_world" ["METADATA:nidrs::metadata::RouterPath"]
// route_derive "get_hello_world"
// route get /hello2 None Some(String("v1"))
// meta "get_hello_world2" ["METADATA:nidrs::metadata::RouterName"]
// meta "get_hello_world2" ["METADATA:nidrs::metadata::RouterMethod"]
// meta "get_hello_world2" ["METADATA:nidrs::metadata::RouterPath"]
// route_derive "get_hello_world2"
// route post /hello None Some(String("v1"))
// meta "post_hello_world" ["METADATA:nidrs::metadata::RouterName"]
// meta "post_hello_world" ["METADATA:nidrs::metadata::RouterMethod"]
// meta "post_hello_world" ["METADATA:nidrs::metadata::RouterPath"]
// route_derive "post_hello_world"
// meta "AppService" ["METADATA:nidrs::metadata::ServiceType::Service"]
// meta "AppService" ["METADATA:nidrs::metadata::ServiceName"]
// service_derive "AppService"
// module "AppModule"
// meta "ConfOptions" ["METADATA:nidrs::metadata::ServiceType::Service"]
// meta "ConfOptions" ["METADATA:nidrs::metadata::ServiceName"]
// service_derive "ConfOptions"
// meta "ConfService" ["METADATA:nidrs::metadata::ServiceType::Service"]
// meta "ConfService" ["METADATA:nidrs::metadata::ServiceName"]
// service_derive "ConfService"
// meta "ConfModule" ["METADATA:nidrs::metadata::Global"]
// module "ConfModule"
// meta "LogInterceptor" ["METADATA:nidrs::metadata::ServiceType::Interceptor"]
// meta "LogInterceptor" ["METADATA:nidrs::metadata::ServiceName"]
// service_derive "LogInterceptor"
// meta "LogService" ["METADATA:nidrs::metadata::ServiceType::Service"]
// meta "LogService" ["METADATA:nidrs::metadata::ServiceName"]
// service_derive "LogService"
// meta "LogModule" ["METADATA:nidrs::metadata::Global"]
// module "LogModule"
// controller UserController []
// meta "UserController" ["METADATA:nidrs::metadata::ServiceType::Controller"]
// meta "UserController" ["METADATA:nidrs::metadata::ServiceName"]
// meta "UserController" ["METADATA:nidrs::metadata::ControllerPath"]
...
// meta "get_hello_world" ["METADATA:nidrs::metadata::RouterPath"]
// route_derive "get_hello_world"
// meta "UserService" ["METADATA:nidrs::metadata::ServiceType::Service"]
// meta "UserService" ["METADATA:nidrs::metadata::ServiceName"]
...
mod app {
    ...
    pub mod controller {
        ...
        impl nidrs::ImplMeta for AppController {
            fn __meta() -> nidrs::Meta {
                ...
                meta.set_data(nidrs::metadata::DisableDefaultPrefix(true));
                meta.set_data(nidrs::metadata::ServiceType::Controller);
                meta.set_data(nidrs::metadata::ServiceName("AppController"));
                meta.set_data(nidrs::metadata::ControllerPath(""));
                meta
            }
        }
        impl AppController {
            pub async fn get_hello_world(
                ...
                };
                {
                    ::std::io::_print(
                        format_args!(
                            "Meta {0:?}\n",
                            meta.get_data::<nidrs::metadata::DisableDefaultPrefix>(),
                        ),
                    );
                };
                Ok((
            ...
            pub fn __meta_get_hello_world(&self) -> nidrs::Meta {
                ...
                meta.set_data(nidrs::metadata::DisableDefaultPrefix(false));
                meta.set("version".to_string(), "v2");
                meta.set_data(nidrs::metadata::RouterName("get_hello_world"));
                meta.set_data(nidrs::metadata::RouterMethod("get"));
                meta.set_data(nidrs::metadata::RouterPath("/hello"));
                meta
            }
            ...
            pub fn __meta_get_hello_world2(&self) -> nidrs::Meta {
                let mut meta = nidrs::Meta::new();
                meta.set_data(nidrs::metadata::RouterName("get_hello_world2"));
                meta.set_data(nidrs::metadata::RouterMethod("get"));
                meta.set_data(nidrs::metadata::RouterPath("/hello2"));
                meta
            }
            ...
            pub fn __meta_post_hello_world(&self) -> nidrs::Meta {
                let mut meta = nidrs::Meta::new();
                meta.set_data(nidrs::metadata::RouterName("post_hello_world"));
                meta.set_data(nidrs::metadata::RouterMethod("post"));
                meta.set_data(nidrs::metadata::RouterPath("/hello"));
                meta
            }
        }
    ...
    pub mod service {
        ...
        impl nidrs::ImplMeta for AppService {
            fn __meta() -> nidrs::Meta {
                let mut meta = nidrs::Meta::new();
                meta.set_data(nidrs::metadata::ServiceType::Service);
                meta.set_data(nidrs::metadata::ServiceName("AppService"));
                meta
            }
        }
        impl AppService {
        ...
        fn init(self, mut ctx: nidrs::ModuleCtx) -> nidrs::ModuleCtx {
                ...
                )
            {
                ...
                let disable_default_prefix = meta
                    .get_data::<nidrs::metadata::DisableDefaultPrefix>()
                    .unwrap_or(&nidrs::metadata::DisableDefaultPrefix(false))
                    .value();
            ...
            ctx.append_exports(
                ...
                nidrs::get_meta_by_type::<ConfModule>()
                    .get_data::<nidrs::metadata::Global>()
                    .unwrap_or(&nidrs::metadata::Global(false))
                    .value(),
            );
    ...
    impl nidrs::ImplMeta for AppModule {
        fn __meta() -> nidrs::Meta {
            let mut meta = nidrs::Meta::new();
            meta.set_data(nidrs::metadata::ModuleName("AppModule"));
            meta
        }
    }
}
mod modules {
    pub mod conf {
        pub mod options {
            ...
            impl nidrs::ImplMeta for ConfOptions {
                fn __meta() -> nidrs::Meta {
                    let mut meta = nidrs::Meta::new();
                    meta.set_data(nidrs::metadata::ServiceType::Service);
                    meta.set_data(nidrs::metadata::ServiceName("ConfOptions"));
                    meta
                }
            }
        }
        pub mod service {
            ...
            impl nidrs::ImplMeta for ConfService {
                fn __meta() -> nidrs::Meta {
                    let mut meta = nidrs::Meta::new();
                    meta.set_data(nidrs::metadata::ServiceType::Service);
                    meta.set_data(nidrs::metadata::ServiceName("ConfService"));
                    meta
                }
            }
            impl ConfService {
        ...
        impl nidrs::ImplMeta for ConfModule {
            fn __meta() -> nidrs::Meta {
                let mut meta = nidrs::Meta::new();
                meta.set_data(nidrs::metadata::Global(true));
                meta.set_data(nidrs::metadata::ModuleName("ConfModule"));
                meta
            }
        }
        impl ConfModule {
    ...
    pub mod log {
        ...
        pub mod interceptor {
            ...
            impl nidrs::ImplMeta for LogInterceptor {
                fn __meta() -> nidrs::Meta {
                    let mut meta = nidrs::Meta::new();
                    meta.set_data(nidrs::metadata::ServiceType::Interceptor);
                    meta.set_data(nidrs::metadata::ServiceName("LogInterceptor"));
                    meta
                }
            }
        ...
        pub mod service {
            ...
            impl nidrs::ImplMeta for LogService {
                fn __meta() -> nidrs::Meta {
                    let mut meta = nidrs::Meta::new();
                    meta.set_data(nidrs::metadata::ServiceType::Service);
                    meta.set_data(nidrs::metadata::ServiceName("LogService"));
                    meta
                }
            }
            impl LogService {
        ...
        impl nidrs::ImplMeta for LogModule {
            fn __meta() -> nidrs::Meta {
                let mut meta = nidrs::Meta::new();
                meta.set_data(nidrs::metadata::Global(true));
                meta.set_data(nidrs::metadata::ModuleName("LogModule"));
                meta
            }
        }
    }
    pub mod user {
        ...
        pub mod controller {
            ...
            impl nidrs::ImplMeta for UserController {
                fn __meta() -> nidrs::Meta {
                    let mut meta = nidrs::Meta::new();
                    meta.set_data(nidrs::metadata::ServiceType::Controller);
                    meta.set_data(nidrs::metadata::ServiceName("UserController"));
                    meta.set_data(nidrs::metadata::ControllerPath("/user"));
                    meta
                }
            }
            impl UserController {
        ...
        pub mod service {
            ...
            impl nidrs::ImplMeta for UserService {
                fn __meta() -> nidrs::Meta {
                    let mut meta = nidrs::Meta::new();
                    meta.set_data(nidrs::metadata::ServiceType::Service);
                    meta.set_data(nidrs::metadata::ServiceName("UserService"));
                    meta
                }
            }
            impl UserService {
        ...
        impl nidrs::ImplMeta for UserModule {
            fn __meta() -> nidrs::Meta {
                let mut meta = nidrs::Meta::new();
                meta.set_data(nidrs::metadata::ModuleName("UserModule"));
                meta
            }
        }
    }
